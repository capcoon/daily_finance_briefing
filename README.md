...
기본 심볼은 [`config/assets.yaml`](config/assets.yaml)에 있으며 국내 시장, 미국 시장, 일본 닛케이 225 지수를 포함합니다. 원자재 등 일부 심볼은 FinanceDataReader가 사용하는 외부 제공처의 정책에 따라 달라질 수 있으므로 운영 전 실제 조회 여부를 확인하세요.
